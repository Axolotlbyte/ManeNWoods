...
export default function Account({ toggle, handleToggle }) {
  ...
  return (
    ...
    >
      {!signup ? (
        <div className="w-11/12 card-anim rounded text-right text-white min-h-form md:w-3/5 md:h-5/6 lg:w-2/5 bg-black bg-opacity-30 backdrop-blur-3xl ">
          <button
            title="close"
          ...
          >
            <svg
              ...
              className="h-7 w-7 fade text-red-600"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div className="w-full h-full flex flex-col items-center justify-start text-center">
            ...
            />
            <button className="p-3 bg-red-700 font-bold w-11/12 md:w-9/12 my-6 mb-4 text-xl">
              Sign in
            </button>
            <small className="mb-4">
              Dont have an account ?{" "}
              <button onClick={() => setSignup(true)} className="text-blue-500">
                Sign up
              </button>
            </small>
          </div>
        ...
        <div className="w-11/12 rounded text-right text-white min-h-form md:w-3/5 md:h-auto  lg:w-2/5 bg-black bg-opacity-30 backdrop-blur-3xl ">
          <button
            title="close"
            onClick={handleToggle}
            className="w-auto h-auto p-4"
