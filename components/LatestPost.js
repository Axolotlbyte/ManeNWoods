export default function LatestPost(){
    ...
    return (
        <div className="hover:shadow-gray-800 hover:ring-2 hover:border-transparent cursor-pointer text-white border hover:shadow-xl  rounded-xl overflow-hidden mt-5 w-11/12 h-50vh grid md:grid-cols-2 mx-auto aspect">
