export default function Card(props) {
  return (
    <>
      <div className="relative bg-red-800 overflow-hidden rounded-3xl card h-card">
        ...
        <div id="prod-name" className="w-full bg-transparent h-auto bg-slate-900 bottom-0 absolute">
