  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-lg card bg-slate-100 h-card">
        <div className="absolute flex items-center justify-center text-white h-14 w-14 bg-slate-900 right-0 rounded-bl-lg ">
          <svg
        ...
        <div className="w-full h-16 bg-slate-900 bottom-0 absolute">
