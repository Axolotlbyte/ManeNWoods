...
export default function Navbar({home}) {
    ...
    return (
        ...
        <nav id="navbar" className="fixed flex z-40 justify-between w-full items-center h-22 bg-tranparent transition-colors">
            ...
            <button className={"transition-all w-10 mx-4 flex items-center justify-center p-1.5 hover:text-black rounded-full hover:bg-slate-300 text-white h-10"}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi h-10 w-10 bi-handbag" viewBox="0 0 16 16">
